...
In general, within an architecture built to support context, you should have it as one of the first inputs to every function that requires flow control. For example:
